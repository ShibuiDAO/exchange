...
contract ERC721Market is Ownab le, Pausable, ReentrancyGuard {
	...
	function createSellOrder(
		...
		SellOrder memory sellOrder = SellOrder(payable(msg.sender), tokenContractAddress, tokenId, expiration, price);
	...
	function _executeSellOrder(SellOrder memory _sellOrder, address payable buyer) internal {
